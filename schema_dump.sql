...
COPY public.event_code (code, description, examples) FROM stdin;
MVIS	VVIP Visits of delegates in BARC	Presidents of India and other countries PM, CM, Ministers, IAEA delegates, etc.
NVIS	Visits of delegates in BARC	Visits from various organizations, institute, defence personal, etc.
TRAF	Traffic Cell Request	Vehicles accidents cases
TECH	Technology transfer	Tech. Transfers, Tech. MoUs Signing, tech. Inaugurations
SIMP	Symposium	International and National Symposium, Seminar, Theme Meeting, Workshop etc.
EVNM	Social and Community Events and Functions	Songs, Drama, Hindi programmes, Library day, quiz, etc.
SEND	Send off parties	Superannuation / Facilitation of employee
EVNS	Scientific and Technical Events and Functions	Trombay Colloquium, Independence day, Republic day, Bhabha Day, tech. Day, etc.
PORT	Portraits Photography	Portraits of distinguished authorities, Chairman DAE, Director BARC, etc.
MISC	Miscellaneous	Miscellaneous Events
LAND	Landscape and outside building	Dhruva, Cirus, Divisional building, views form Bhabha Point, etc.
INDU	Industrial Photography	Divisional equipment and materials, instruments, workshop machines etc.
GARD	Gardens, Trees view	Close photography of Flowers, buds, trees, etc.
CONF	Confidential	Confidential Coverage of event, setup, equipments etc.
\.
...
1	MVIS	Photography	Photographer 1, Photographer 2	retirement	Outdoor	2025-03-26	2025-03-26	09:00:00	14:00:00	shreya	9863546365	baviskarpranali04@gmail.com	sd		f	MVIS/2025/1	2025-03-24 16:32:38.853986
...
6	MVIS	Photography	Photographer 1, Photographer 2	Roadies Double cross	Outdoor	2025-03-25	2025-03-25	10:00:00	01:00:00	Phweyfdwev	93724333894	cbgdxfglktg@gmail.com	a		f	MVIS/2025/6	2025-03-24 16:39:45.157386
...
49	TRAF	Photography	John Doe, Emily Johnson	gudi padwa	Outdoor Garden	2025-04-03	2025-04-05	12:00:00	15:00:00	sam	9372433107	baviskarpranali04@gmail.com	CC		f	TRAF/2025/47	2025-04-03 14:29:24.070361
\.
...
134	49	2025-04-03	John Doe
135	49	2025-04-04	John Doe
136	49	2025-04-05	Emily Johnson
\.
...
SELECT pg_catalog.setval('public.job_detail_photoid_seq', 49, true);
...
SELECT pg_catalog.setval('public.job_photographers_id_seq', 136, true);
...
SELECT pg_catalog.setval('public.keyword_entry_keyno_seq', 24, true);
...
SELECT pg_catalog.setval('public.keywords_id_seq', 67, true);
